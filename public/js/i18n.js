...
const I18N = {
  ht: {
    ...
    // konfyans: temwayaj + FAQ
    testi_title: "Sa moun ap di",
    testi1_quote: "Enskripsyon an te rapid, epi mwen resevwa lis la san pwoblèm apre objektif la te rive.",
    testi2_quote: "Mwen te renmen fason yo eksplike tout bagay anvan m enskri — pa gen okenn sipriz.",
    testi3_quote: "Sit la senp e klè. Mwen kontan wè konbyen moun ki deja enskri anvan m fè demach mwen.",
    faq_title: "Kesyon moun poze souvan",
    faq_q1: "Poukisa m dwe bay nimewo m?",
    faq_a1: "Nimewo w la sèvi pou mete w nan lis kontak yo pou plis moun ka wè status ou sou WhatsApp. Li pa janm afiche piblikman sou sit la — sèlman non w parèt nan lis la.",
    faq_q2: "Kilè m ap ka download?",
    faq_a2: "Download la debloke otomatikman lè kantite moun ki enskri rive nan minimòm ki nesesè a. Ba pwogrè a anwo montre w kote n rive.",
    faq_q3: "Èske nimewo m ap afiche piblikman?",
    faq_a3: "Non. Sou paj \"Lis moun\", sèlman non yo afiche — jamè nimewo telefòn okenn moun.",
    faq_q4: "Èske li gratis pou enskri?",
    faq_a4: "Wi, enskripsyon an 100% gratis. Pa gen okenn peman ki mande pou w antre nan lis la.",
  ...
  en: {
    ...
    testi1_quote: "Registration was quick, and I got the list without any issues once the goal was reached.",
    testi2_quote: "I liked that everything was explained before I registered — no surprises.",
    testi3_quote: "The site is simple and clear. I liked seeing how many people were already registered before signing up.",
    faq_title: "Frequently asked questions",
    faq_q1: "Why do I need to give my number?",
    faq_a1: "Your number is used to add you to the contact list so more people can see your WhatsApp status. It's never shown publicly on the site — only your name appears in the list.",
    faq_q2: "When can I download?",
    faq_a2: "Download unlocks automatically once the number of registrations reaches the required minimum. The progress bar above shows where things stand.",
    faq_q3: "Is my number shown publicly?",
    faq_a3: "No. On the \"People list\" page, only names are shown — never anyone's phone number.",
    faq_q4: "Is registration free?",
    faq_a4: "Yes, registration is 100% free. No payment is required to join the list.",
  ...
  fr: {
    ...
    testi_title: "Ce que les gens disent",
    testi1_quote: "L'inscription a été rapide, et j'ai reçu la liste sans problème une fois l'objectif atteint.",
    testi2_quote: "J'ai aimé que tout soit expliqué avant de m'inscrire — aucune surprise.",
    testi3_quote: "Le site est simple et clair. J'ai aimé voir combien de personnes étaient déjà inscrites avant de m'inscrire.",
    faq_title: "Questions fréquentes",
    faq_q1: "Pourquoi dois-je donner mon numéro ?",
    faq_a1: "Ton numéro sert à t'ajouter à la liste de contacts pour que plus de gens voient ton statut WhatsApp. Il n'est jamais affiché publiquement sur le site — seul ton nom apparaît dans la liste.",
    faq_q2: "Quand pourrai-je télécharger ?",
    faq_a2: "Le téléchargement se débloque automatiquement quand le nombre d'inscriptions atteint le minimum requis. La barre de progression ci-dessus montre où on en est.",
    faq_q3: "Mon numéro est-il affiché publiquement ?",
    faq_a3: "Non. Sur la page \"Liste des personnes\", seuls les noms sont affichés — jamais le numéro de téléphone de qui que ce soit.",
    faq_q4: "L'inscription est-elle gratuite ?",
    faq_a4: "Oui, l'inscription est 100% gratuite. Aucun paiement n'est requis pour rejoindre la liste.",
